...
html+='<div class="rssHeader">Wireless News</div>';html+='<div class="rssBody">'+'<ul>';

for(var i=0;i<feeds.entries.length;i++){
    var entry=feeds.entries[i];var entryDate=new Date(entry.publishedDate);
    //var pubDate=entryDate.toLocaleDateString()+' '+entryDate.toLocaleTimeString();
    var pubDate = '[' + (entryDate.getMonth() + 1) + '/' + entryDate.getDate() + '/' + entryDate.getFullYear() + ' ' + entryDate.toLocaleTimeString() + ']';
    html+='<li class="rssRow '+row+'">'+'<'+options.titletag+'>'+entry.title
...
html+='<a href="'+entry.link+'" title="View this story" target="'+options.linktarget+'">'+content+'</a>'+'</'+options.titletag+'>'}
