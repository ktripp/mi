<?php
  ...
  */
  ...
  class geekMail
  {
    ...
    */
    public function attach($filename, $disposition = 'attachment'/*'inline'*/, $real_filename = '')
    {
      $this->_attachName[] = $filename;
      $this->_attachPath[] = empty($real_filename) ? $filename : $real_filename;
    ...
    */
    private function _buildMessage()
    {
      ...
      for ($i=0; $i < count($this->_attachName); $i++)
      {
        ...
        $basename = basename($this->_attachPath[$i]);
